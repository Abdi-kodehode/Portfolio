...
const About = () => {
  return (
    <div
      name="about"
      className="w-full h-full pt-20 bg-[#0a192f] text-gray-300"
    >
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          ...
          <div>
            ...
            <p>
              ...
              Throughout the course, I acquired knowledge of HTML/CSS,
              JavaScript, and React. Most recently, I've been working with
              Node.js, and I'm absolutely thrilled with the power and
              flexibility it offers for the backend. As an organized
            ...
            <p>
              ...
              you're looking to collaborate on something truly remarkable, let's
              team up and create something that will leave a lasting impact.
            </p>
          </div>
        </div>
      </div>
